      ...
      <>
         <header className="container mx-auto grid lg:grid-cols-[1fr_2fr] xl:grid-cols-[1fr_3fr] mt-10 p-5">
            ...
            <div className="text-lg">
               ...
               <p className="px-3 my-8 dark:text-gray-400">สวัสดีครับ จะขอเรียกแทนตัวเองว่า"ผม"นะครับ ผมชื่อเล่นชื่อเจอาร์ หรือจะเรียก เจ , จา หรือจะเรียกแบบไหนก็ได้ที่อยากเรียก หมายถึงแบบไหนก็ได้ที่เป็นคำที่สุภาพนะ😅 นิสัยหรือบุคลิกของผมก็จะเป็นคนที่เงียบๆไม่ค่อยจะสุงสิงกับผู้อื่นแต่ก็สามารถทำงานร่วมกันกับผู้อื่นได้โดยไม่ได้อึดอัดใจอะไร ผมชอบการเขียนโปรแกรมมากและชอบการแก้ปัญหา Error ที่เกิดขึ้น ชอบที่เวลาแก้ปัญหาอะไรได้เสร็จก็จะรู้สึกดีใจที่สุด</p>
            ...
            <section className="container mx-auto flex flex-col xl:flex-row justify-between">
               <div className="max-w-[800px] flex flex-col justify-center gap-y-10 px-2 order-2 xl:order-none">
                  <div className="border-l-4 px-3 border-orange-400">
                     ...
                     <p className="dark:text-gray-400 text-md text-[19px]">เว็บไซต์นี้มีชื่อว่า Jaguar Blog สร้างเพื่อทำบทความแบ่งปันความรู้ในเรื่องต่างๆที่ผมนั้นพอที่จะรู้ทั้ง คอมพิวเตอร์ คณิตศาสตร์ วิทยาศาสตร์ ภาษาอังกฤษ Technologies และอื่นๆอีกมากมาย หลักการในการทำเว็บไซต์นี้ก็คือใช้งานง่าย เข้าถึงได้ ผมจะเน้นไปที่เรื่องการเข้าถึงที่ง่ายและไม่มีอะไรซับซ้อนโดยจะสังเกตได้จากหน้าหลักและเกี่ยวกับซึ่งมีอยู่แค่ 2 หน้า เพื่อประโยชน์แก่ผู้อื่นที่เข้ามาเยี่ยมชมไม่มากก็น้อย ขอขอบคุณทุกท่านนะครับ ^^</p>
                  </div>
